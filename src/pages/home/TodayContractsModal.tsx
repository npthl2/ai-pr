...
import { ContentContainer } from './TodayContractsModal.styled';
...
const TodayContractsModal = ({ open, onClose, signupId }: TodayContractsModalProps) => {
