...
const ModifiedServiceSelect = () => {
  ...
  const handlePlanChange = (
    _: SyntheticEvent,
    newValue: string | Service | (string | Service)[] | null,
  ) => {
    ...
    if (!newValue || typeof newValue === 'string' || Array.isArray(newValue)) return;

    const selectedServiceData =
      services.find((service: Service) => service.serviceId === newValue.serviceId) || null;
          ...
          <AutocompleteContainer>
            <Autocomplete
              ...
              getOptionLabel={(option) => {
                return (option as Service).serviceName;
              }}
              isOptionEqualToValue={(option, value) => {
                return (option as Service).serviceId === (value as Service).serviceId;
              }}
              ...
              renderOption={(props, option) => (
                ...
                >
                  ...
                  >
                    <Typography>{(option as Service).serviceName}</Typography>
                    <ServicePrice>{(option as Service).serviceValue.toLocaleString()}</ServicePrice>
                  </Box>
                </Box>
              )}
              renderInput={(params) => (
