...
import { useCheckServiceModifiableQuery, useCustomerCurrentServiceQuery } from '@api/queries/modifyService/useModifyServiceQuery';
...
const ServiceModification = () => {
  ...
  }, [isLoading, modifiableData, contractId, setServiceModifiable, setIsChangedToday, isServiceModificationTabActive]);
  ...
  useEffect(() => {
    ...
    if (currentServiceData && currentServiceData.previousService && isServiceModificationTabActive) {
