...
describe('KAN-39 가입정보 요약 테스트', () => {
  ...
  //   it('KAN-39-2-3-2 고객조회로 이동 버튼을 클릭 했을 때 신규가입 탭을 닫고 고객조회 탭으로 이동해야 한다', () => {
  //     // 고객조회로 이동 버튼 클릭
  ...
  //     // 고객조회 탭으로 이동 확인
  //     registrationPage.visitCustomerDetailPage();
  //     registrationService.successWhenGetCustomerContracts();
  //     registrationPage.assertTree();
  //     registrationPage.assertInformation();
  //   });
  // });
  })
});
