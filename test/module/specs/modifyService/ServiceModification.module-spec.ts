...
describe('KAN-22 요금제/부가서비스 변경', () => {
  ...
  //   it('변경할 요금제 박스를 포커스 했을 때 전체 요금제 리스트가 보여야 한다', () => {
  //     // 요금제 선택 박스 클릭
  //     page.clickServiceSelectBox();
      
  //     // 요금제 목록이 모두 표시되는지 확인
  //     page.assertServiceInList('5G 스탠다드 요금제');
  //     page.assertServiceInList('5G 프리미엄 요금제');
  //     page.assertServiceInList('데이터 무제한 요금제');
  //   });
  ...
  //     // 검색어 입력
  //     page.typeServiceSearchKeyword('프리미엄');
  ...
  //     page.assertServicePriceVisible();
  //   });
  ...
  //     // 요금제 변경 확인 모달이 표시되는지 확인
  //     page.assertServiceChangeModalVisible();
  //   });
  ...
  //     // 선택한 요금제가 적용되었는지 확인
  //     page.assertSelectedServiceIs('5G 프리미엄 요금제');
      
  //     // 금액이 표시되는지 확인 (75,000원)
  //     page.assertTotalAmountIs('75,000원');
  //   });
  ...
  //     // 요금제 선택
  //     page.selectServiceFromList('데이터 무제한 요금제');
      
  //     // 요금제 변경 불가 모달(나이 제한)이 표시되는지 확인
  //     page.assertModalTypeIs('AGE_RESTRICTION');
  //   });
  // });
